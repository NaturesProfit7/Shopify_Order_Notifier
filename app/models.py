...
from sqlalchemy import (
    BigInteger, String, Enum, Boolean, DateTime, func, Index
)
...
class Order(Base):
    ...
    chat_id: Mapped[Optional[str]] = mapped_column(String(64))      # куда отправили менеджеру
    last_message_id: Mapped[Optional[int]] = mapped_column()        # message_id с кнопками
